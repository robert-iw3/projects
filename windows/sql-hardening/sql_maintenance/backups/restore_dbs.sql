...
DECLARE @Temp TABLE (FileName NVARCHAR(512));

INSERT INTO @Temp EXEC master..xp_dirtree @BaseDir + 'FULL', 1, 1;
INSERT INTO #BackupFiles (FolderType, FileName) SELECT 'FULL', FileName FROM @Temp; DELETE FROM @Temp;

INSERT INTO @Temp EXEC master..xp_dirtree @BaseDir + 'DIFF', 1, 1;
INSERT INTO #BackupFiles (FolderType, FileName) SELECT 'DIFF', FileName FROM @Temp; DELETE FROM @Temp;

INSERT INTO @Temp EXEC master..xp_dirtree @BaseDir + 'LOG', 1, 1;
INSERT INTO #BackupFiles (FolderType, FileName) SELECT 'LOG', FileName FROM @Temp;
